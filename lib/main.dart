...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Connection Page'),
    );
  }
}
...
///////////////////////////////////////////////////////////////////
    final buttons = Row(
        ...
        children: <Widget>[
          ...
          ElevatedButton(
            //style: style,
            child: const Text('Liste Horizontale'),
            onPressed: () {
              Navigator.push(
                context,
          ...
          ElevatedButton(
            //style: style,
            child: const Text('Formulaire ajout'),
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ajoutSavon()),
              );
            },
          ),
          const SizedBox(width: 10),
